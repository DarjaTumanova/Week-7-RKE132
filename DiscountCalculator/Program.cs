...
double newTotal = CalculateNuwTotal(userInput, discount);

Console.WriteLine($"Your updates total with {discount}%: {newTotal}");
...
static double CalculateNuwTotal(double total, double discount)
{
